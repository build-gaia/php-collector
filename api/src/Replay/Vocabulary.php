...
final class Vocabulary
{
    ...
    /**
     * Kinds that annotate a recording but are never Effect lookups (ADR 0021 call-path /
     * truncation markers). They must not enter the selectable index or unconsumed accounting.
     */
    public static function isObservational(string $kind): bool
    {
        return $kind === 'call' || $kind === 'custom:call_path_truncated';
    }
